...
func TestUpdateQuality(t *testing.T) {
	tests := []struct {
		...
		{"'Sulfuras' never has to be sold or decreases in Quality", &Item{"Sulfuras, Hand of Ragnaros", 5, 80}, &Item{"Sulfuras, Hand of Ragnaros", 5, 80}},
		...
		{"'Conjured' item quality not below 0", &Item{"Conjured", 15, 1}, &Item{"Conjured", 14, 0}},
		{"'Conjured' item quality not below 0", &Item{"Conjured", -2, 1}, &Item{"Conjured", -3, 0}},
	}
